...
// Number of relays in the hardware. Keep this in sync with `Relays` array. You MUST have at least 1 relay for the system to function, but you
// can set this to less than the number of defined relay pins if your board doesn't use them all.
