...
// Root CA certificate for api.github.com and github.com (release download CDN).
...
// Used by setCACert() in WiFiClientSecure to validate TLS instead of setInsecure().
