...
class PageSplash : public BaseDisplayPage
{
public:
    PageSplash(Stream* serialPort)
		: BaseDisplayPage(serialPort)
    {}

    uint8_t getPageId() const override { return PageIdSplash; }
    ...
    void begin() override
    {
        ...
        sendText(F("pageSplash.vaBoatName"), config->location.name);
