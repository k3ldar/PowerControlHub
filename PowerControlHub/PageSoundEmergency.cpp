...
PageSoundEmergency::PageSoundEmergency(Stream* serialPort,
...
void PageSoundEmergency::begin()
{

}

void PageSoundEmergency::refresh(unsigned long now)
{
	(void)now;
}

// Handle touch events for buttons
void PageSoundEmergency::handleTouch(uint8_t compId, uint8_t eventType)
{
	(void)eventType;
