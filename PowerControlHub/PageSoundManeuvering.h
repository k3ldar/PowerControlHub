...
class PageSoundManeuvering : public BasePage
{
private:
...
protected:
    // Required overrides
    uint8_t getPageId() const override { return PageIdSoundManeuveringSignals; }
    void begin() override;
...
public:
    explicit PageSoundManeuvering(Stream* serialPort,
