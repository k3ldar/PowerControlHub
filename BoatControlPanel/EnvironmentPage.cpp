...
EnvironmentPage::EnvironmentPage(Stream* serialPort,
...
void EnvironmentPage::onEnterPage()
{
	updateHumidity();
	updateTemperature();
	updateLatLon();
...
void EnvironmentPage::handleTouch(uint8_t compId, uint8_t eventType)
{
    (void)eventType;
...
void EnvironmentPage::handleExternalUpdate(uint8_t updateType, const void* data)
{
...
void EnvironmentPage::updateTemperature()
{
    if (isnan(_lastTemp))
    {
...
void EnvironmentPage::updateHumidity()
{
...
void EnvironmentPage::updateLatLon()
{
...
void EnvironmentPage::updateSunriseSunset()
{
...
void EnvironmentPage::updateCondensation()
{
...
void EnvironmentPage::updateDewPoint()
{
...
void EnvironmentPage::updateComfortDescription(double dewPoint)
{
    char buffer[24];
